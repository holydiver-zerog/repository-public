...
# QA表_2506e宮城/Excel:No.27 /質問内容
# -------------------------------------------------------------------------------------------------
"""
ディクショナリの要素を順序性を保持した状態でリストに変換できないか試してみました
下記コードで少ない件数だと順序性を保持できているように見えますがどうなのでしょうか？
ぜひ評価をお願いします。

#テスト用ディクショナリ
array_Dic = {'A':123,'B':456,'C':789,'D':321,'E':654,'F':987,'G':741,'H':852,'I':963}
